...
void dispensar_heroi(Lista *lista, int id) {
    ...
    // ====================================
    //
    // Lembre-se de tratar os 4 casos descritos no problema:
    // 1. A lista está vazia.
    // 2. O herói a ser removido é o primeiro da lista.
    // 3. O herói está no meio ou no final da lista.
    // 4. O herói com o ID fornecido não existe na lista.
    
    printf("\nFuncao 'dispensar_heroi' ainda nao implementada.\n"); // Remova essa linha após implementar a função.
}